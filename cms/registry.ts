...
import { OT_ContactFormDefault }     from '@/cms/display-templates/OT_ContactFormDefault'
...
import { OT_ContactForm }           from '@/cms/content-types/OT_ContactForm'
...
import OT_ContactFormAdapter           from '@/cms/components/OT_ContactForm'
...
initReactComponentRegistry({
  resolver: createTokenAwareResolver({
    ...
    OT_ContactForm:           OT_ContactFormAdapter,
