...
export const OT_ThemeManager = contentType({
  ...
  properties: {
    ...
    primaryFont: {
      ...
      description: 'Sets the primary typeface for the entire site — display headers down to body and labels. Every option holds up under the display, gradient-fill, and bloom treatments. Syne stays reserved for select accent areas.',
      group: 'OT_Theme',
      sortOrder: 185,
      enum: [
        { value: 'ibmPlex',       displayName: 'IBM Plex Sans — neutral, engineered (default)' },
        { value: 'poppins',       displayName: 'Poppins — geometric, friendly' },
